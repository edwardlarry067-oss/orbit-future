...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 md:bottom-8 md:right-6 z-40 flex items-center gap-3 transition-all duration-300 hover:scale-105 active:scale-95"
    >
      {hovered && (
      ...
      <div className="relative w-12 h-12 md:w-14 md:h-14 flex items-center justify-center bg-[#25D366] hover:bg-[#20b858] rounded-full shadow-[0_4px_24px_rgba(37,211,102,0.5)] hover:shadow-[0_4px_40px_rgba(37,211,102,0.75)]">
